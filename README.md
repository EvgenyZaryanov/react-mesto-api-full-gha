...
Mesto - это интерактивное SPA-приложение, в котором пользователи могут загружать фотографии, удалять их и ставить лайки. Работает фунционал редактирования профиля, есть возможность поменять имя, информацию о себе и аватар. 
